        ...
        <div className="flex justify-between items-start max-md:flex-col gap-6">
          <div className="flex gap-20 max-md:flex-col max-md:gap-6">
            <div className="flex flex-col gap-2">
              <p className="text-grey cursor-pointer hover:text-black">About</p>
              <p className="text-grey cursor-pointer hover:text-black">Blog</p>
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-grey cursor-pointer hover:text-black">Press</p>
              <p className="text-grey cursor-pointer hover:text-black">
                Help Center
              </p>
            </div>
